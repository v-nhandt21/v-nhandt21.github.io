...
excerpt: '<p style='text-align: justify;'>With motivation of reconstructing voices for people who are mute after an accident or a person who has died and there is a small amount of data about their voices, this thesis aims to conduct experiments and
...
a new voice clone sytem, which is able to synthesize any person’s voice with only a few sample audio input of that person’s voice.</p>'
date: 2021-01-01
venue: 'Thesis'
paperurl: ''
...
<iframe src="/files/Thesis.pdf" width="100%" height="4000"></iframe>
