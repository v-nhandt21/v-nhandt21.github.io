...
I am **Do Tri Nhan**, an AI Engineer specializing in **Speech and Signal Processing**, currently working as **Senior AI Engineer, Conversational Speech Technology** at [Vinfast Automotive AI Development Institute - Vingroup JSC](https://vinfast.com), Ho Chi Minh City, Vietnam.
...
- **MLOps:** TensorRT, Triton Inference Server, TorchServe, Docker, FastAPI, RabbitMQ
...
I maintain two widely used Vietnamese NLP packages on PyPI:

- **[vinorm](https://github.com/NoahDrisort/vinorm)** – Vietnamese Text Normalization (34,933+ downloads / 6 months)
- **[viphoneme](https://github.com/v-nhandt21)** – Vietnamese Grapheme-to-IPA Phonetization (4,195+ downloads / 6 months)

## Selected Awards

- Outstanding Employee of the Year – VinBigdata (2023)
- 1st Place, VLSP TTS Emotional Speech Synthesis (2022)
- 1st Prize, Science-A-Thon, 9th Vietnamese Summer School of Science (2022)
- Outstanding Student Award in AI, Ho Chi Minh City (2021)
- Excellent Thesis – Science and Technology Student Award (2021)

## Contact

Feel free to reach out at **dotrinhan99@gmail.com** or connect via [LinkedIn](https://www.linkedin.com/in/dtnhan) and [Google Scholar](https://scholar.google.com.vn/citations?user=XTQmR3gAAAAJ&hl=vi&authuser=3).
